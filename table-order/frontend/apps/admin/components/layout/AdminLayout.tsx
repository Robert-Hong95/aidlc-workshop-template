...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div data-testid="admin-layout" className="h-screen flex flex-col bg-[#F2F3F3]">
      <AdminHeader storeName={storeName} onMenuToggle={() => setMobileOpen(!mobileOpen)} onLogout={handleLogout} />
      <div className="flex flex-1 overflow-hidden">
        ...
        {mobileOpen && (
          <div className="lg:hidden fixed inset-0 z-40 flex">
            <div className="w-56"><Sidebar collapsed={false} onToggle={() => setMobileOpen(false)} currentPath={pathname} /></div>
